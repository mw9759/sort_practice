...
public class SortTest {
	public static void main(String[] args) {
		...
		System.out.println("강감찬".compareTo("강감찬")); // 같으면 0
		System.out.println("강감찬".compareTo("홍길동")); // 작으면 음수
		System.out.println("홍길동".compareTo("강감찬")); // 크면    양수
		...
		// Collection List: "홍길동","홍길동","강감찬","이순신","김유신","유관순"
		List<String> list = Arrays.asList("홍길동","홍길동","강감찬","이순신","김유신","유관순"); // TODO
